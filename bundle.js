...
/***/ function(module, exports, __webpack_require__) {
	...
	var Clock = __webpack_require__(163);
	var Weather = __webpack_require__(161);
	var Autocomplete = __webpack_require__(164);
	...
	document.addEventListener("DOMContentLoaded", function () {
	  ReactDOM.render(React.createElement(Autocomplete, { names: ['kevin', 'eric', 'max', 'ned', 'keith', 'kanye'] }), document.getElementById('main'));
	});
	...
	var Autocomplete = React.createClass({
	  ...
	  render: function () {
	    return React.createElement(
	      "ul",
	      null,
	      React.createElement("input", { onChange: this.toAutoComplete, value: this.state.selected }),
	      this.state.matchedWords.map(function (name, index) {
	        return React.createElement(
	          "li",
	          { key: index, onClick: this.toFill },
	          name
	        );
	      }.bind(this))
	    );
